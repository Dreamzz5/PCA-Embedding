...
class MegaCRN(BaseModel):
    def __init__(self,  rnn_units, num_layers=1, cheb_k=3,
                 ycov_dim=1, mem_num=20, mem_dim=64, cl_decay_steps=2000, 
    ...
    def forward(self, history_data, future_data, node_embeddings, batch_seen=None, epoch=None, **kwargs):

        x = history_data[..., [0]]
        y_cov = history_data[..., [1]]
        labels = future_data[..., [0]]
        
        node_embeddings1 = node_embeddings
        node_embeddings2 = node_embeddings
