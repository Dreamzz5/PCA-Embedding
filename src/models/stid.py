...
class STID(BaseModel):
    ...
    def __init__(self, if_spatial=True, dropout=0.15, **args):
    ...
    def forward(self, history_data, label=None, node_embed=None) -> torch.Tensor:
        ...
        if self.if_spatial:
            ...
            node_emb = node_embed.unsqueeze(0).expand(batch_size, -1, -1).transpose(1, 2).unsqueeze(-1)
