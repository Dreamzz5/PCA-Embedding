...
class DGCRN(BaseModel):
    ...
    def step(self, input, node_embed, Hidden_State, Cell_State, predefined_adj, type='encoder', i=None):
        x = input
    ...
    def forward(self, input, label=None, node_embed=None, batches_seen=None, task_level=12):  # (b, t, n, f)
        ...
        for i in range(self.seq_len):
            Hidden_State, Cell_State = self.step(torch.squeeze(x[..., i]), node_embed, 
        ...
        for i in range(task_level):
            try:
                ...
                sys.exit(0)
            Hidden_State, Cell_State = self.step(decoder_input, node_embed, Hidden_State,
